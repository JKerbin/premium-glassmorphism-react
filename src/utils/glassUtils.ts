  ...
  switch (variant) {
    ...
    case 'gradient':
      baseStyle.background = background || 
        `linear-gradient(135deg, rgba(255, 255, 255, ${opacity}) 0%, rgba(59, 130, 246, ${opacity * 0.8}) 100%)`;
      break;
  }
...
export const getGlassVariants = () => ({
  ...
  gradient: {
    background: 'linear-gradient(135deg, rgba(255, 255, 255, 0.1) 0%, rgba(59, 130, 246, 0.08) 100%)',
    border: '1px solid rgba(255, 255, 255, 0.2)',
  },
});
